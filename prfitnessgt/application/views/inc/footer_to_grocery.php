<footer class="footer">
        ...
        <!--            <nav class="pull-left">
                    ...
                    <div class="copyright pull-right"> 
						&copy; <script>document.write(new Date().getFullYear())</script>, desarrollado por <a href="http://intranet.congreso.gob.gt/pl/" target="_blank">Dirección de Informática y Comunicaciones  </a>
	...
	<?php if($this->uri->segment(1) == "boletas" &&  $this->uri->segment(2) == "add" ||  $this->uri->segment(2) == "edit"):?>
<!-- <script src="assets/js/angular/boletas.js"></script> -->
	<?php endif; ?>
...
<!-- 	<script src="<?=base_url()?>assets/js/bootstrap-selectpicker.js"></script> -->
	...
	<!--  Google Maps Plugin    -->
<!-- 	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDABKKmF68iZ9EoAjqowBpE71jCf9IGbjg"></script> -->
	...
	<!--   Sharrre Library    -->
    <script src="<?=base_url()?>assets/theme/js/jquery.sharrre.js"></script>
    <script src="<?=base_url()?>assets/theme/js/demo.js"></script>
	<script src="<?=base_url()?>assets/theme/js/jquery.language_es.js"></script>
