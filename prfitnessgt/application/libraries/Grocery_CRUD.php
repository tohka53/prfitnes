...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function insert_layout($insert_result = false)
	{
		...
		else
		{
			...
			echo json_encode(array(
					'success' => true ,
					'insert_primary_key' => $insert_result,
                    /* Se eliminó el mensaje por errores del encode que hace json - OSCAR CEBALLOS - 24-2019 */
					//'success_message' => $success_message
                    'success_message' => "El dato se ingreso correctamente",
	...
	protected function get_true_false_input($field_info,$value)
	{
		...
		$input .=
			"<div class=\"radio\">
				<input id='field-{$field_info->name}-true' style=\"color:green !important\" type=\"radio\" name=\"{$field_info->name}\" value=\"1\" $checked />
			<label>
				$true_string
			 </label> </div>";
	...
	protected function get_relation_input($field_info,$value)
	{
        ...
        /*ingresar opcion selecciona - OSCAR CEBALLOS - 24/01/2019 */
		$input .= "<option value=''>-Selecciona -</option>";
