...
demo = {
    ...
    initCirclePercentage: function() {
        ...
        $('#chartAmountMaterias, #chartDashboard, #chartOrders, #chartNewVisitors, #chartSubscriptions, #chartDashboardDoc, #chartOrdersDoc').easyPieChart({
            lineWidth: 6,
            size: 160,
    ...
    showSwal: function(type) {
        ...
        } else if (type == 'olvidaste-clave') {
            swal({
                title: "olvidaste tu contaseña!",
                text: "Comunicate con el administrador o con Miguel Cabrera",
        ...
        } else if (type == 'error-number') {
            swal({
                title: "Error en uno de los campos!",
                text: "Debes llenar todos los campos para realizar esta acción",
                buttonsStyling: false,
                confirmButtonClass: "btn btn-danger btn-fill"
            });

        } else if (type == 'success-message-save') {
            swal({
                title: "Buen Trabajo!",
                text: "Se hace guardado correctamente el dato!",
                timer: 2500,
